...
//class OpenAdUseForSplash {
//
//    companion object {
//        private var dialog: Dialog? = null
//        private const val TAG = "OpenAdUseForSplash"
//        var appOpenAd: AppOpenAd? = null
//        private var loadCallback: AppOpenAdLoadCallback? = null
//        private var isAdFetching: Boolean = false // Flag to track ad fetching
//        var adDismiss=false
//
//        fun fetchAd(context: Activity) {
...
//                AppOpenAd.load(
//                    context,
//                    App.remoteModel!!.splashOpenAd.adID,
//                    request,
...
//        }
//
//        fun commonMethod(activity: Activity){
//
//            if (!SharedPreferencesHelper(activity).getFirstTimeInstall()) {
//
//                activity.moveAct(activity,HowToUseAct::class.java)
//            } else {
//
//                if (activity.checkForInternet()) {
//
//                    activity.moveAct(activity,ProAct::class.java)
//
//                } else {
//                    activity.moveAct(activity,ProAct::class.java)
//
